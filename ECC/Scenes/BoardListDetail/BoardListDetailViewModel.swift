...
class BoardListDetailViewModel: ObservableObject {
    
    @Published var kindergartenBoardDetails: [BoardDetail] = [
    ...
    @Published var kidsBoardDetails: [BoardDetail] = [
    ...
    @Published var youthBoardDeteails: [BoardDetail] = [
    ...
    @Published var youngAdultsBoardDeteails: [BoardDetail] = [
    ...
    @Published var oldAdultsBoardDeteails: [BoardDetail] = [
